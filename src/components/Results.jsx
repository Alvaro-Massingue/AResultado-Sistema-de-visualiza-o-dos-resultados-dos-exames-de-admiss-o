const Results = (props) => {
  return (
    <div className="flex flex-col md:mt-40 items-center shadow-lg shadow-black pt-6 pb-8 gap-10 bg-white">
      {props.results.map((result) => (
        <div
          key={result.id}
          className="bg-white rounded-2xl  border border-sky-500  font-extralight w-[90%]  p-2"
        >
