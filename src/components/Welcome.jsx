...
const Welcome = () => {
  ...
  return (
    <div className="w-full md:h-100 h-95  m-0 mt-10 md:mt-20  flex items-center flex-wrap wrap-break-word bg-linear-to-r from-sky-50 via-sky-200 to-sky-50">
      <div className=" basis-full grow shrink ">
        <div className="h-3/4 flex justify-center items-center text-center w-full">
